...
//*** CLA Angle Signals ***//
logic [31:0] z_sum_n;
logic [31:0] angle_seven;

//*** Comparator Signals ***//
logic [3:0] select_function;
logic [31:0] angle_seven_pre;
...
comparator_multi_iteration Comparator_seven(
    .data_in(angle_seven[26:23]),
    .select_function(select_function)
);

angle_table_seven Angle_Table_seven(
    .select_function(select_function[2:0]),
    .angle_seven(angle_seven_pre)
);

two_complementer Two_Complementer_Angle (
    .data_in(angle_seven_pre),
    .enable(~select_function[3]), // Negate the carry input
    .data_out(angle_seven_n)
);
