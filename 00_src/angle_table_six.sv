module angle_table_six(
    input logic [2:0] select_function,
    output logic [31:0] angle_six
);
...
always_comb begin
   case(select_function)
        SELECT__FUNC_4: angle_six = POS_4;
        SELECT__FUNC_3: angle_six = POS_3;
        SELECT__FUNC_2: angle_six = POS_2;
        SELECT__FUNC_1: angle_six = POS_1;
        SELECT__FUNC_0: angle_six = ZERO;
       default: angle_six = ZERO;
    endcase
end
