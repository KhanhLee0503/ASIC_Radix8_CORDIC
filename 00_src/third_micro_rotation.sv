module third_micro_rotation(
    ...
    output logic [2:0] select_function_2,
...
//*** CLA Angle Signals ***//
logic [31:0] z_sum_n;
logic [31:0] angle_two;

//*** Comparator Signals ***//
logic [3:0] select_function_pre;
logic [31:0] angle_two_pre;
...
assign select_function_2 = select_function_pre[2:0];
