...
//*** CLA Angle Signals ***//
logic [31:0] z_sum_n;
logic [31:0] angle_three;

//*** Comparator Signals ***//
logic [3:0] select_function;
logic [31:0] angle_three_pre;
...
comparator_multi_iteration Comparator_Three(
    .data_in(angle_three[26:23]),
    .select_function(select_function)
);

angle_table_three Angle_Table_Three(
    .select_function(select_function[2:0]),
    .angle_three(angle_three_pre)
);

two_complementer Two_Complementer_Angle (
    .data_in(angle_three_pre),
    .enable(~select_function[3]), // Negate the carry input
    .data_out(angle_three_n)
);
