...
//*** CLA Angle Signals ***//
logic [31:0] z_sum_n;
logic [31:0] angle_five;

//*** Comparator Signals ***//
logic [3:0] select_function;
logic [31:0] angle_five_pre;
...
comparator_multi_iteration Comparator_five(
    .data_in(angle_five[26:23]),
    .select_function(select_function)
);

angle_table_five Angle_Table_Five(
    .select_function(select_function[2:0]),
    .angle_five(angle_five_pre)
);

two_complementer Two_Complementer_Angle (
    .data_in(angle_five_pre),
    .enable(~select_function[3]), // Negate the carry input
    .data_out(angle_five_n)
);
