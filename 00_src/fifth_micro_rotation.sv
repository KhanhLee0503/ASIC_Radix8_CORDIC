...
//*** CLA Angle Signals ***//
logic [31:0] z_sum_n;
logic [31:0] angle_four;

//*** Comparator Signals ***//
logic [3:0] select_function;
logic [31:0] angle_four_pre;
...
comparator_multi_iteration Comparator_Four(
    .data_in(angle_four[26:23]),
    .select_function(select_function)
);

angle_table_four Angle_Table_Four(
    .select_function(select_function[2:0]),
    .angle_four(angle_four_pre)
);

two_complementer Two_Complementer_Angle (
    .data_in(angle_four_pre),
    .enable(~select_function[3]), // Negate the carry input
    .data_out(angle_four_n)
);
