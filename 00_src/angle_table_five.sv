module angle_table_five(
    input logic [2:0] select_function,
    output logic [31:0] angle_five
);
...
//**Angle Table Values (Radian) ----8^5 . arctan(select_function . 8^-5)---**//
parameter POS_4 = 32'h04000000;     //3.99999998
parameter POS_3 = 32'h02ffffff;     //2.99999992
...
always_comb begin
   case(select_function)
        SELECT__FUNC_4: angle_five = POS_4;
        SELECT__FUNC_3: angle_five = POS_3;
        SELECT__FUNC_2: angle_five = POS_2;
        SELECT__FUNC_1: angle_five = POS_1;
        SELECT__FUNC_0: angle_five = ZERO;
       default: angle_five = ZERO;
    endcase
end
